...
public class NotificationUtils {
    ...
    public void addNewRfqToCustomerFromSale(Long rfqId) {
        ...
        sendNotificationToRole("SALE_STAFF", msg, NotificationEnum.SUCCESS, targetUrl, "Đơn báo giá mới");
    }
    ...
    public void sentQuotationToSaleStaffToCustomer(Long rfqId, Long userId) {
        ...
        sendNotificationToUser(userId, msg, NotificationEnum.SUCCESS, targetUrl, "Xác Nhận Báo Giá");
    }
    ...
    public void sentFalseEasyToQaFromTechnical(Long rsId) {
        ...
        sendNotificationToRole("TECHNICAL", msg, NotificationEnum.SUCCESS, targetUrl, "Lỗi Nhẹ");
    }

    public void sentFalseSeriousToQaFromTechnical(Long rsId) {
        String msg = "Kết quả kiểm tra lỗi, hãy kiểm tra.";
        String targetUrl = "/risk-solution/technical/detail/" + rsId;
        sendNotificationToRole("TECHNICAL", msg, NotificationEnum.SUCCESS, targetUrl, "Lỗi Nặng");
    }
    ...
    public void sentSuccessStageToLeaderFromQA(Long dyeBatchId, String role) {
        ...
        sendNotificationToRole("QA_DYE", msg, NotificationEnum.SUCCESS, targetUrl, "Nhuộm Hoàn Thành");
        }else if(role.equalsIgnoreCase("QA_WINDING")){
            String msg = "Công đoạn đánh côn đã hoàn thành, chờ kiểm tra";
            String targetUrl = "/work-order/technology-process/" + dyeBatchId;
            sendNotificationToRole("QA_WINDING", msg, NotificationEnum.SUCCESS, targetUrl, "Đánh Côn Hoàn Thành");
        }else{
            String msg = "Công đoạn đóng gói đã hoàn thành, chờ kiểm tra";
            String targetUrl = "/work-order/technology-process/" + dyeBatchId;
            sendNotificationToRole("QA_PACKAGING", msg, NotificationEnum.SUCCESS, targetUrl, "Đóng Gói Hoàn Thành");
        }
    }
    ...
    public void sentSuccessTestToQaFromLeader(Long dyeBatchId, String role) {
        if(role.equalsIgnoreCase("LEAD_WINDING")){
            ...
            String targetUrl = "/work-order/technology-process/" + dyeBatchId;
            sendNotificationToRole("LEAD_WINDING", msg, NotificationEnum.SUCCESS, targetUrl, "Nhuộm Đạt Chuẩn");
        }else if(role.equalsIgnoreCase("LEAD_PACKAGING")){
            String msg = "Công đoạn đánh côn đạt chuẩn chất lượng, chờ đóng gói";
            String targetUrl = "/work-order/technology-process/" + dyeBatchId;
            sendNotificationToRole("LEAD_PACKAGING", msg, NotificationEnum.SUCCESS, targetUrl, "Đánh Côn Đạt Chuẩn");
        }
    }
    ...
    public void sentFalseSeriousFromTechnicalToPo(Long rsId) {
        ...
        sendNotificationToRole("PRODUCTION_MANAGER", msg, NotificationEnum.SUCCESS, targetUrl, "Phiếu Yêu Cầu Cấp Sợi");
    }
    ...
    public void sentRedoStageFromPoToDyeLeader(Long dyeBatchId) {
        ...
        String targetUrl = "/work-order/technology-process/" + dyeBatchId;
        sendNotificationToRole("LEAD_DYE", msg, NotificationEnum.SUCCESS, targetUrl, "Làm Lại Mẻ Lỗi");
    }
