...
public class Thread extends BaseEntity {
  ...
  public Thread(Long id, LocalDateTime createAt, LocalDateTime updateAt, String name, String description,
      BigDecimal convert_rate, WindingProcess process, List<Product> products) {
