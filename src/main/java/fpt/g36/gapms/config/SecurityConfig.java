    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers("/risk-solution/production-manager/**", "/production-manager/**","/work-order/production-manager/**").hasRole("PRODUCTION_MANAGER")
                        ...
                        .requestMatchers("/work-order/quality_assurance/**").hasAnyRole("QA_DYE", "QA_WINDING", "QA_PACKAGING")
